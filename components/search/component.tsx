...
export const Search: FC<SearchProps> = ({
  ...
  return (
    <div
      className={cx('flex w-full relative border-b border-slate-400', {
        [THEME[theme]]: true,
        [SIZES[size]]: true,
      })}
    >
      ...
      <input
        ...
        type="search"
        className={cx(
          'w-full font-sans px-10 bg-transparent truncate leading-4 placeholder-slate-300 placeholder-opacity-50',
          {
            [THEME[theme]]: true,
            [SIZES[size]]: true,
          }
