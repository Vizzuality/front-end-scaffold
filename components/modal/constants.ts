export const COMMON_CONTENT_CLASSES =
  'absolute top-1/2 inset-x-4 sm:left-1/2 transform -translate-y-1/2 sm:-translate-x-1/2 outline-none bg-white flex flex-col grow overflow-hidden rounded-3xl py-7';
