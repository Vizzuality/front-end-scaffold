...
import MapImplementation from './map-implementation';
...
* 1) Add deckGL dependencies
  ```bash
  yarn add @deck.gl/core @deck.gl/extensions @deck.gl/geo-layers @deck.gl/layers @deck.gl/mapbox @deck.gl/mesh-layers
  ```
