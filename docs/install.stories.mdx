...
Then, add the corresponding keys and urls. You can use the following example:

```
HOSTNAME=localhost
PORT=3000

NEXT_PUBLIC_FRONTEND_URL=http://$HOSTNAME:$PORT
...
NEXT_PUBLIC_MAPBOX_API_TOKEN=pk.eyJ1IjoibGV0aWNpYWhlY28iLCJhIjoiY2tzeGg3emczMHBzdTJ1cndkdXIxeGxlZyJ9.8yNE1jEYkE6tu-MAUzUfrA
STORYBOOK_MAPBOX_API_TOKEN=$NEXT_PUBLIC_MAPBOX_API_TOKEN
